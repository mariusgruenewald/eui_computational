...
function solve_general_model_SSJ(prim::Parameter, r::Float64)
    ...
    @unpack a_grid_log, tol, maxiter, α, A, δ = prim
...
function partial_jacobian_r(prim::Parameter, r_init::Float64, dist_init::Matrix{Float64}, cons_init::Matrix{Float64}, 
    ...
    @unpack nz, na, A, sim_periods, ϵ = prim
...
function partial_jacobian_w(prim::Parameter, wage_init::Float64, dist_init::Matrix{Float64}, cons_init::Matrix{Float64}, 
    ...
    @unpack nz, na, A, α, δ, sim_periods, ϵ = prim
...
@time dK = solve_SSJ(-0.1, 1)

# Visualize IRF
IRF_capital_log = plot(1:100, dK, label = "IRF of Capital", dpi=300, title = "Temporary shock to productivity")
xaxis!("Periods")
yaxis!("Change")
savefig(IRF_capital_log,"IRF_capital_log.png")
